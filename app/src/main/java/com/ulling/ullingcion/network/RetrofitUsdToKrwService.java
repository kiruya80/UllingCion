...
public class RetrofitUsdToKrwService extends QcBaseRetrofitService {

    private static UsdToKrwApi apiInterface;
    public static Retrofit retrofit = null;

    public synchronized static UsdToKrwApi getInstance() {
    ...
    private static UsdToKrwApi provideApiService() {
        return getRetrofit(ApiUrl.BASE_USD_TO_KRW_URL, provideClient(false)).create(UsdToKrwApi.class);
    }
